...
<div id="demo" class="carousel slide" data-ride="carousel" data-interval="2500">
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src="images/light4.jpg" alt="light" width="100%" height="500">
    </div>
    <div class="carousel-item">
      <img src="images/light7.jpg" alt="Hydrangeas" width="100%" height="500">
    </div>
    <div class="carousel-item">
      <img src="images/fan1.jpg" alt="Jellyfish" width="100%" height="500">
    </div>
  </div>
                                ...
                                <div class="featured_slider slider">
                                    ...
                                    <div class="featured_slider_item">
                                        ...
                                        <div class="product_item discount d-flex flex-column align-items-center justify-content-center text-center">
                                            <div class="product_image d-flex flex-column align-items-center justify-content-center"><img src="images/light1.jpg" alt=""></div>
                                    ...
                                    <div class="featured_slider_item">
                                        ...
                                        <div class="product_item is_new d-flex flex-column align-items-center justify-content-center text-center">
                                            <div class="product_image d-flex flex-column align-items-center justify-content-center"><img src="light2.jpg" alt=""></div>
                                            <div class="product_content">
                                    ...
                                    <div class="featured_slider_item">
                                        ...
                                        <div class="product_item d-flex flex-column align-items-center justify-content-center text-center">
                                            <div class="product_image d-flex flex-column align-items-center justify-content-center"><img src="images/fan.jpg" alt=""></div>
                                            <div class="product_content">
                                                <div class="product_price">$379</div>
                                    ...
                                    <div class="featured_slider_item">
                                        <div class="border_active"></div>
                                        <div class="product_item discount d-flex flex-column align-items-center justify-content-center text-center">
                                            <div class="product_image d-flex flex-column align-items-center justify-content-center"><img src="images/light5.jpg" alt=""></div>
                                            <div class="product_content">
                                                <div class="product_price discount">$225<span>$300</span></div>
                                    ...
                                    <div class="featured_slider_item">
                                        <div class="border_active"></div>
                                        <div class="product_item d-flex flex-column align-items-center justify-content-center text-center">
                                            <div class="product_image d-flex flex-column align-items-center justify-content-center"><img src="images/images/featured_5.png" alt=""></div>
                                            <div class="product_content">
...
<!-- Deals -->
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src="images/adv1.jpg" alt="Desert" width="100%" height="500">
    </div>
    <div class="carousel-item">
      <img src="images/adv2.jpg" alt="Hydrangeas" width="100%" height="500">
    </div>
    <div class="carousel-item">
      <img src="images/adv3.jpg" alt="Jellyfish" width="100%" height="500">
    </div>
  </div>
                        ...
                        <div class="deals_slider_container">
                            ...
                            <div class="owl-carousel owl-theme deals_slider">
                                ...
                                <div class="owl-item deals_item">
                                    <div class="deals_image"><img src="adv1.jpg" alt=""></div>
                                    <!--
                                ...
                                <!-- Deals Item --
                                <div class="owl-item deals_item">
                                    <div class="deals_image"><img src="adv2.jpg" alt=""></div>
                                    <!--
                                    <div class="deals_content">
                                        <div class="deals_info_line d-flex flex-row justify-content-start">
                                            <div class="deals_item_category"><a href="#">Headphones</a></div>
                                ...
                                <!-- Deals Item --
                                <div class="owl-item deals_item">
                                    <div class="deals_image"><img src="adv3.jpg" alt=""></div>
                                    <!--
                                    <div class="deals_content">
                                        <div class="deals_info_line d-flex flex-row justify-content-start">
                                            <div class="deals_item_category"><a href="#">Headphones</a></div>
        ...
        <div class="container">
            <div class="row">
                <div class="col">
                    <div class="tabbed_container">
                        <div class="tabs clearfix tabs-right">
                            <div class="new_arrivals_title" style="color: #fff;">Hot Best Sellers</div>
                            <ul class="clearfix">
                                <li class="active" style="color: #fff;">Top 20</li>
